...
export default function PopularCategories() {
  ...
  return (
    <div className="w-full bg-white py-14 px-4 sm:px-6 lg:px-10">

      {/* Header */}
      <div className="flex flex-col items-center gap-2 mb-10">
        <h2 className="section-heading text-2xl font-bold text-gray-900">Popular Categories</h2>
        <p className="caption text-sm text-gray-400">Explore top artisan services</p>
      </div>

      {/* Cards Grid — padding removed, handled by parent */}
      <motion.div
          ...
          return (
            ...
            >
              ...
              <div className="text-center">
                <h3 className="card-title text-sm font-bold text-gray-900">{cat.title}</h3>
                <p className="caption text-xs text-gray-400">{cat.subtitle}</p>
              </div>
            </motion.div>
          );
        })}
      ...
      <div
        ...
        className="small-label flex items-center justify-center gap-2 mt-10 text-green-700 font-semibold text-sm cursor-pointer hover:underline"
      >
